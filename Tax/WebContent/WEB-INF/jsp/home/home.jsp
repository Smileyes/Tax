	...
	<table width="1222" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<td width="418" height="106" align="left" valign="middle"><img
				class="zxx_test_png" src="${ctx}/images/home/ind01.png" width="470"
				height="90" alt="" /></td>
			<td width="211">&nbsp;</td>
			<td width="328"><object id="FlashID"
					...
					<object type="application/x-shockwave-flash"
						data="${ctx}/images/home/flash.swf" width="380" height="86">
						<!--<![endif]-->
						<param name="quality" value="high" />
						<param name="wmode" value="transparent" />
						<param name="swfversion" value="6.0.65.0" />
			...
			<td width="331" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td align="center"></td>
						<td align="left"></td>
						<td align="right"><a><b></b><font color="red">欢迎您，<s:property
										value="#session.SYS_USER.name" />&nbsp;
							</font></a></td>
						<td align="center"><img src="${ctx}/images/home/help.png"
							width="12" height="17" /></td>
						<td align="left"><a href="javascript:void(0);">帮助</a></td>
						<td align="center"><img src="${ctx}/images/home/exit.png"
							width="14" height="14" /></td>
						<td align="left" valign="middle"><a
							href="${ctx}/sys/login_logout.action">退出</a></td>
					</tr>
				</table>
			</td>
		</tr>
				...
				<table width="98%" border="0" align="center">
					<tr>
						<td width="76" height="100" align="center" valign="middle">
							<div class="left-tx">
								<s:if test="%{#session.SYS_USER.headImg == null}">
									<img src="${ctx}/images/home/gs09.png" width="70" height="70" />
								</s:if>
								<s:else>
									<img
										src="${ctx}<s:property value='#session.SYS_USER.headImg'/>"
										width="70" height="70" />
								</s:else>
							</div>
						</td>
						<td width="5%"><img src="${ctx}/images/home/gs10.png"
							width="4" height="59" alt="" /></td>
						<td width="60%"><table width="95%" border="0" cellpadding="0"
								cellspacing="0">
								<tr>
									<td colspan="2" style="font-weight: bold; color: #3a7daa;"><s:property
											value="#session.SYS_USER.name" /></td>
								</tr>
								<tr>
									<td colspan="2">所属部门：<s:property
											value="#session.SYS_USER.dept" /></td>
								</tr>
							</table></td>
					</tr>
				</table>
		...
		<div class="right">
			<div class="left_grzx1">
				...
				<table width="98%" border="0" align="center">
					...
					<tr align="center">
						<td height="23">信息标题</td>
						<td width="150px">信息分类</td>
						<td width="150px">发布者</td>
					...
					<s:iterator value="infoPageResult.items" var="sta">
						<tr align="center">
							...
							<td width="180px"><s:date name="createTime"
			...
			<div class="lc_grzx1">
				<div class="lc_grzxbt">
					...
					<div style="float: right; padding-top: 3px;">
						<s:a action="home_complainAddUI" target="_blank">我要投诉</s:a>
						&nbsp;&nbsp;
					</div>
				</div>
				<table width="98%" border="0" align="center">
