...
<body class="rightBody">
	<form id="form" name="form" action="${basePath }nsfw/info_add.action"
					...
					<table id="baseInfo" width="100%" align="center" class="list"
						...
						<tr>
							...
							<td><s:property value="#session.SYS_USER.name" /> <s:hidden
									name="info.creator" value="%{#session.SYS_USER.name}" /></td>
...
<%
	application.setAttribute("uploadPath", "upload/info");
%>
</html>