...
<%
	System.out.println("1:" + request.getRealPath("/upload/info"));
	System.out.println("2:" + application.getAttribute("uploadPath"));
	System.out.println("3:" + request.getContextPath());
	request.setCharacterEncoding("utf-8");
	response.setCharacterEncoding("utf-8");
	Uploader up = new Uploader(request);
	up.setSavePath(request.getContextPath() + "/upload/info");
	...
	if (callback == null) {
		...
		response.getWriter()
				.print("<script>" + callback + "(" + result + ")</script>");
	}
%>
