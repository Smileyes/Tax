...
<body>
	...
	<table width="1222" border="0" align="center" cellpadding="0"
		cellspacing="0" background="${basePath}images/nsfw/xingzheng.png"
		class="top">
		<tr>
			<td width="26" height="106">&nbsp;</td>
			<td width="416" height="110" align="left" valign="middle"><img
				class="zxx_test_png" src="${basePath}images/home/ind01.png"
				width="470" height="90" alt="" /></td>
			<td width="135">&nbsp;</td>
			<td width="418"><object id="FlashID"
					...
					<object type="application/x-shockwave-flash"
						data="${basePath}images/home/flash.swf" width="380" height="86">
						<!--<![endif]-->
						<param name="quality" value="high" />
						<param name="wmode" value="transparent" />
						<param name="swfversion" value="6.0.65.0" />
				...
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td align="left" valign="middle"><a
							href="${basePath}sys/login_logout.action" target="_top">退出</a></td>
					</tr>
				</table>
			</td>
		</tr>
