		...
		<div class="p_d_1">
			<div class="p_d_1_1">
				<div class="content_info">
					<div class="c_crumbs">
						<div>
							<b></b><strong>服务预约管理</strong>
						</div>
					</div>
					<div class="search_art">
						<li>预约编号：<s:textfield name="reserve.no" cssClass="s_text"
								cssStyle="width:160px;" />
						</li>
						<li>预约时间：<s:textfield id="startTime" name="startTime"
								cssClass="s_text" cssStyle="width:160px;" /> - <s:textfield
								id="endTime" name="endTime" cssClass="s_text"
								cssStyle="width:160px;" />
						</li>
						<li>状态：<s:select name="reserve.state"
								list="#{'':'全部','0':'预约失败','1':'预约成功' }" />
						</li>
					...
					<div class="t_list" style="margin: 0px; border: 0px none;">
						<table width="100%" border="0">
							...
							<tr bgcolor="f8f8f8">
								...
								<td align="center"></td>
								<td align="center"></td>
								<td align="center"><a href="javascript:doDeal()">处理</a></td>
							</tr>
