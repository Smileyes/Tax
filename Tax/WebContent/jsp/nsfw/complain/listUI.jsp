			...
			<div class="p_d_1_1">
				<div class="content_info">
					...
					<div class="search_art">
						<li>投诉标题：<s:textfield name="complain.compTitle"
						...
						<li>状态：<s:select name="complain.state" list="" />
						</li>
						...
						<table width="100%" border="0">
							...
							<s:iterator value="pageResult.items" status="st">
								<tr <s:if test="#st.odd"> bgcolor="f8f8f8" </s:if>>
									...
									<td align="center"><s:date name="compTime"
											format="yyyy-MM-dd HH:mm" /></td>
									<td align="center"><s:property
											value="#complainStateMap[state]" /></td>
									<td align="center"><a
										href="javascript:doDeal('<s:property value='compId'/>')">受理</a>
									</td>
								</tr>
							</s:iterator>
						</table>
