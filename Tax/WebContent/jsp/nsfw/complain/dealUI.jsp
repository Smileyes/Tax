		...
		<div class="p_d_1">
			<div class="p_d_1_1">
				<div class="content_info">
					...
					<div class="tableH2">
						投诉详细信息<span style="color: red;">(已受理)</span>
					</div>
						...
						<tr>
							<td colspan="2">
								...
								<fieldset style="border: solid 1px #c0c0c0; margin-top: 5px;">
									<legend style="color: green; font-weight: bold;">回复1&nbsp;</legend>
									<div
										style="width: 100%; text-align: center; color: #ccc; maring-top: 5px;">
										回复部门：xxx&nbsp;&nbsp; 回复人：xxx&nbsp;&nbsp; 回复时间：xxx</div>
									<div
										style="width: 100%; maring-top: 10px; font-size: 13px; padding-left: 5px;">xxx</div>
								</fieldset>
